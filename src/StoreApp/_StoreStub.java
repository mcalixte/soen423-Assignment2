...
public class _StoreStub extends org.omg.CORBA.portable.ObjectImpl implements StoreApp.Store
{
  ...
  public String exchange (String customerID, String newItemID, String oldItemID, String dateOfReturn)
  {
            ...
            try {
                ...
                return exchange (customerID, newItemID, oldItemID, dateOfReturn        );
            } finally {
                _releaseReply ($in);
            }
  } // exchange
  ...
  public void requestUpdateOfCustomerBudgetLog (String customerID, double price)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("requestUpdateOfCustomerBudgetLog", true);
                $out.write_string (customerID);
                $out.write_double (price);
                $in = _invoke ($out);
                return;
                ...
                requestUpdateOfCustomerBudgetLog (customerID, price        );
            } finally {
                _releaseReply ($in);
            }
  } // requestUpdateOfCustomerBudgetLog
  ...
  public boolean waitList (String customerID, String itemID, String dateOfPurchase)
  {
            ...
            try {
                ...
                return waitList (customerID, itemID, dateOfPurchase        );
            } finally {
                _releaseReply ($in);
            }
  } // waitList
