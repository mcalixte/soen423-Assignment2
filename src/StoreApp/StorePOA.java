 ...
 implements StoreApp.StoreOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("requestUpdateOfCustomerBudgetLog", new java.lang.Integer (6));
    _methods.put ("waitList", new java.lang.Integer (7));
  ...
  //Not to be used remotely
       case 6:  // StoreApp/Store/requestUpdateOfCustomerBudgetLog
       {
         String customerID = in.read_string ();
         double price = in.read_double ();
  ...
  //WaitList method
       case 7:  // StoreApp/Store/waitList
       {
         String customerID = in.read_string ();
         String itemID = in.read_string ();
         String dateOfPurchase = in.read_string ();
